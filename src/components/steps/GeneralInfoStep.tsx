...
const GeneralInfoStep = () => {
    ...
    const handleTeamChange = (value: string) => {
        setSurveyData((prev) => ({
            ...
            isSingleMember:
                ConfigTeam.find((team) => team.id === value)?.member == 1,
        }));
    };
            ...
            <Card className="border border-survey-accent shadow-lg">
                <CardHeader className="bg-gradient-to-r from-survey-primary to-survey-secondary text-white rounded-t-lg">
                    <CardTitle className="text-2xl">
                        Đánh giá hiệu quả và sự hài lòng với team
                    </CardTitle>
                ...
                <CardContent className="pt-6">
                    <h2 className="text-xl font-semibold mb-4 text-survey-dark">
                        I. Thông tin chung
                    </h2>
              ...
              name: e.target.value
                        ...
                        <div className="p-4 bg-survey-light border border-survey-accent rounded-lg">
                            <p className="text-sm">
                                <span className="font-medium text-survey-primary">
                                    📝 Ghi chú:
                                </span>
                                <br />- Khi đánh giá các team khác, dù team đó
                                chỉ có 1 người, hãy đánh giá dựa trên trải
